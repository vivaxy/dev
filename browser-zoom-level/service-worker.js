(() => {
  ...
  (() => {
    ...
    class M {
      ...
      async setTimestamp(e, t) {
        const s = {
          ...
          n = (await this.getDb()).transaction(I, 'readwrite', {
            durability: 'relaxed',
          });
    ...
    let X;
    const Y = () => (
      X || ((X = new z()), X.addFetchListener(), X.addCacheListener()), X
    );
    function Z(e, s, n) {
      let a;
      if ('string' === typeof e) {
    ...
    self.addEventListener('activate', () => self.clients.claim()),
      (function (e) {
        ...
        { revision: 'c62a79c1e7274104834d36ac00ae5763', url: './index.html' },
        { revision: null, url: './static/css/main.82f59000.css' },
        { revision: null, url: './static/js/main.bd53daef.js' },
      ]),
      (function (e) {
        const t = G();
        Z(new ee(t, e));
